...
use Defacto\LicenseBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DefactoLicenseBundle:User')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DefactoLicenseBundle:User')->find($id);
     ...
     * @Method("post")
     * @Template("DefactoLicenseBundle:User:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("DefactoLicenseBundle:User:edit.html.twig")
     */
